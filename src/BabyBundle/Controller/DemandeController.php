...
//                ->add('disponibilite', DateType::class)
    ...
    public function alldemandeAction()
    {
        $tasks = $this->getDoctrine()->getManager()
            ->getRepository('BabyBundle:Demande')
            ->findAll();
        $serializer = new Serializer([new ObjectNormalizer()]);
        $formatted = $serializer->normalize($tasks);
        return new JsonResponse($formatted);
    }
    public function MydemandeAction($idb)
    {
        $tasks = $this->getDoctrine()->getManager()
            ->getRepository('BabyBundle:Demande')
            ->findByIdb($idb);
    ...
    public function DeletedemandeAction($id)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $voiture = $em->getRepository("BabyBundle:Demande")->find($id);
        $em->remove($voiture);
    ...
    public function updatedemandeAction($id,$nom,$prenom,$adrese,$disponibilite,$idb,$email,$prix,$description,$image,$datefin)
    {


        $em = $this->getDoctrine()->getManager();
        $baby = $em->getRepository("BabyBundle:Demande")->find($id);
        //$em->remove($voiture);
        $baby->setNom($nom);
